const recipes = [
	{
		...
		alt: 'Stack of golden-brown savory waffles on a white plate with arugula and cherry tomatoes.',
		recipeIngredient: [
			'2 separated eggs',
			'1/4 C Oil',
			'1/4 tsp salt',
	...
	},
	{
		...
		alt: 'Chicken breasts topped with creamy mushroom sauce and sautéed mushroom slices on a plate.',
		recipeIngredient: [
	...
	},
	{
		...
		alt: 'Crispy roasted potato slices on a foil-lined baking sheet.',
		recipeIngredient: [
			'3-4 Medium Potatoes',
			'1 Tbsp Olive oil',
	...
	},
	{
		...
		alt: 'Pot of rice mixed with black beans, diced tomatoes and onions.',
		recipeIngredient: [
	...
	},
	{
		...
		alt: 'Plate curry chicken served with white rice and pieces of naan, with curry in a skillet nearby.',
		recipeIngredient: [
			'4 Slices Bacon',
			'1 clove Garlic',
			'2 Tbsp Flour',
	...
	},
	{
		...
		alt: 'Round crumb-topped cheesecake with a gooseberry filling, one slice removed.',
		recipeIngredient: [
			'For the Cake Base:',
	...
	},
	{
		...
		alt: 'Warm apple crisp topped with a scoop of vanilla ice cream in a white bowl.',
		recipeIngredient: [
...
let recipeContainer = document.querySelector('#recipe-card-container');

let button = document.getElementById('search-button');
let input = document.getElementById('recipe-search');
const form = document.querySelector('.search-bar');

// prevent full page refresh on submit
form.addEventListener('submit', (e) => {
    e.preventDefault();
    search();
});

// optional: keep Enter key triggering search without duplicate submit
